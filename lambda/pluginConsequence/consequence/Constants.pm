...
use consequence::OverlapConsequence;
...
our $DEFAULT_OVERLAP_CONSEQUENCE = consequence::OverlapConsequence->new_fast({
...
'sequence_variant' => consequence::OverlapConsequence->new_fast({
...
'upstream_gene_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::upstream',
  'rank' => '24',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'downstream_gene_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::downstream',
  'rank' => '25',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'5_prime_UTR_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::within_5_prime_utr',
  'rank' => '18',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'3_prime_UTR_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::within_3_prime_utr',
  'rank' => '19',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'synonymous_variant' => consequence::OverlapConsequence->new_fast({
  'NCBI_term' => 'cds-synon',
  ...
  'predicate' => 'consequence::VariationEffect::synonymous_variant',
  'rank' => '15',
  'tier' => '3',
  'variant_feature_class' => 'consequence::VariationFeature'
}
),
'missense_variant' => consequence::OverlapConsequence->new_fast({
  'NCBI_term' => 'missense',
  ...
  'predicate' => 'consequence::VariationEffect::missense_variant',
  'rank' => '12',
  'tier' => '3',
  'variant_feature_class' => 'consequence::VariationFeature'
}
),
'inframe_insertion' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::inframe_insertion',
  'rank' => '10',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'inframe_deletion' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::inframe_deletion',
  'rank' => '11',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'stop_gained' => consequence::OverlapConsequence->new_fast({
  'NCBI_term' => 'nonsense',
  ...
  'label' => 'stop gained',
  'predicate' => 'consequence::VariationEffect::stop_gained',
  'rank' => '4',
  'tier' => '3',
  'variant_feature_class' => 'consequence::VariationFeature'
}
),
'stop_lost' => consequence::OverlapConsequence->new_fast({
  ...
  'label' => 'stop lost',
  'predicate' => 'consequence::VariationEffect::stop_lost',
  'rank' => '6',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'stop_retained_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::stop_retained',
  'rank' => '15',
  'tier' => '3',
  'variant_feature_class' => 'consequence::VariationFeature'
}
),
'start_lost' => consequence::OverlapConsequence->new_fast({
  ...
  'label' => 'start lost',
  'predicate' => 'consequence::VariationEffect::start_lost',
  'rank' => '7',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'start_retained_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::start_retained_variant',
  'rank' => '15',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'frameshift_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::frameshift',
  'rank' => '5',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'incomplete_terminal_codon_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::partial_codon',
  'rank' => '14',
  'tier' => '3',
  'variant_feature_class' => 'consequence::VariationFeature'
}
),
'NMD_transcript_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::within_nmd_transcript',
  'rank' => '22',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'non_coding_transcript_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::within_non_coding_gene',
  'rank' => '23',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'non_coding_transcript_exon_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::non_coding_exon_variant',
  'rank' => '20',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'mature_miRNA_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::within_mature_miRNA',
  'rank' => '17',
  'tier' => '2',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'coding_sequence_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::coding_unknown',
  'rank' => '16',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'regulatory_region_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::within_regulatory_feature',
  'rank' => '36',
  'tier' => '2',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'TF_binding_site_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::within_motif_feature',
  'rank' => '30',
  'tier' => '2',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'transcript_ablation' => consequence::OverlapConsequence->new_fast({
...
'transcript_amplification' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::feature_amplification',
  'rank' => '8',
  'tier' => '1',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'TFBS_ablation' => consequence::OverlapConsequence->new_fast({
...
'regulatory_region_ablation' => consequence::OverlapConsequence->new_fast({
...
'regulatory_region_amplification' => consequence::OverlapConsequence->new_fast({
...
'feature_elongation' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::feature_elongation',
  'rank' => '36',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
),
'feature_truncation' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::feature_truncation',
  'rank' => '37',
  'tier' => '3',
  'variant_feature_class' => 'consequence::BaseVariationFeature'
}
  ...
  'predicate' => 'consequence::VariationEffect::donor_splice_site',
  'rank' => '3',
  'tier' => '3',
  'variant_feature_class' => 'consequence::VariationFeature'
}
),
'splice_acceptor_variant' => consequence::OverlapConsequence->new_fast({
  'NCBI_term' => 'splice-3',
  ...
  'predicate' => 'consequence::VariationEffect::acceptor_splice_site',
  'rank' => '3',
  'tier' => '3',
  'variant_feature_class' => 'consequence::VariationFeature'
}
),
'splice_region_variant' => consequence::OverlapConsequence->new_fast({
  ...
  'predicate' => 'consequence::VariationEffect::splice_region',
  'rank' => '13',
  'tier' => '3',
  'variant_feature_class' => 'consequence::VariationFeature'
}
