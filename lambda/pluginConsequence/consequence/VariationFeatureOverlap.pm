...
package consequence::VariationFeatureOverlap;
...
use consequence::Sequence qw(expand);
#use Bio::EnsEMBL::Variation::Utils::Sequence qw(unambiguity_code);
use consequence::VariationFeatureOverlapAllele;

use base qw(consequence::BaseVariationFeatureOverlap);
...
sub new {
  ...
  $self->add_VariationFeatureOverlapAllele(
    consequence::VariationFeatureOverlapAllele->new(
