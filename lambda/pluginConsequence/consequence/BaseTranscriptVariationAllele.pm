...
package consequence::BaseTranscriptVariationAllele;

use strict;
use warnings;

use consequence::VariationEffect qw(overlap _intron_overlap);

use base qw(consequence::BaseVariationFeatureOverlapAllele);
